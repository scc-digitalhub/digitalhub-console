export const specs = {
    ...
    'python+build': {
        title: 'Build di codice Python',
        description: "Definizione dell'operazione di build del codice Python",
    },
    'python+job': {
        title: 'Job Python',
    ...
    'python+serve': {
        ...
        description: "Definizione dell'operazione di serve del codice Python",
    },
    dbt: {
        title: 'DBT',
        description: '',
